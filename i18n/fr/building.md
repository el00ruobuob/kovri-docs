...
Rendez-vous sur le [README](https://github.com/monero-project/kovri/blob/master/README.md) pour télécharger une version pré-compilée de kovri et les fichiers de somme de contrôle. Vous n'aurez plus qu'à installer et démarrer Kovri, c'est parti !
