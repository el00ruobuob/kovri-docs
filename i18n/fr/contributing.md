...
5. Envoyez une demande de récupération (*pull request*) à la branche `master`
   ...
   - En général, les commits doivent être [atomique](https://en.wikipedia.org/wiki/Atomic_commit#Atomic_commit_convention) et les différences doivent être facile à distinguer. Essayez donc de ne pas mélanger les corrections de mise en forme avec les corrections d'erreurs.
